...
The deployment uses the Node.js 24-compatible major versions of GitHub's official Pages actions, avoiding the Node.js 20 deprecation warning on current GitHub-hosted runners.
